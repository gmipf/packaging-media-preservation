...
# runs through Xwayland. Weak deps — never enter the OBS build root. Names
# below are the Fedora spellings; port to openSUSE runtime names (libX11-6,
# libICE6, Mesa-libGL1, libfreetype6, ...) so a GUI install pulls them.
Recommends:     libX11
Recommends:     libICE
Recommends:     libSM
Recommends:     libXext
