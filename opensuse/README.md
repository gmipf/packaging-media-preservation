# The OBS lane — openSUSE, Debian and Ubuntu
...
| Debian 12, 13 | `opensuse/<tool>/<tool>.dsc` + `debian.tar.gz` | **generated** from `ubuntu/<tool>/debian/` |
| Ubuntu 22.04, 24.04, 26.04 | same | same |
